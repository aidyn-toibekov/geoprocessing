...
(function () {
    ...
    global.core = function (command) {
        ...
        if (options.type && options.type.toString) {
            ...
            // scriptBaseUri.
            // We first check whether the swfUrl derived is undefined or blank.
            // If so, we do not need to add a directory path separator.
             options.swfUrl = (((options.swfUrl =
                 (global.core.options.swfSrcPath || options.swfSrcPath ||
                    global.core.options.scriptBaseUri)) ?
                    '' : (options.swfUrl + '/')) +
                  options.type.replace(/\.swf\s*?$/ig, '')) + '.swf'; // #FMXT-325
        }
...
FusionCharts(['private', 'modules.renderer.highcharts', function () {
     ...
     * @const
     */
    SET_AS_PRIMARY_RENDERER = /*#rep JS_Renderer_Primary*/false/*#endrep*/,
    ...
    MODULE_NAME_BASE = 'modules.renderer.highcharts-',
