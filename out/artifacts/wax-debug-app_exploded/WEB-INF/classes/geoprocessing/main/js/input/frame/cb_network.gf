...
<gf:attr name="daoname" value="Network/list"/>
<gf:attr name="title" value="Сети"/>
...
<g:javascript id="gridColumns" method="gridColumns" params="b, res">
  res.push(
      b.column('code', {tdCls: "td-wrap", flex: 1}),
      b.column('name', {tdCls: "td-wrap", flex: 3})
  );
</g:javascript>
...
<g:javascript id="gridOrderBy" method="gridOrderBy" params="b, res">
  res.push(
      {name: "code", title: "По коду"},
      {name: "name", title: "По имени"}
  );
</g:javascript>
